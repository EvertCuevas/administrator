...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1>Registro Asiento de Ingreso</h1>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Formulario Registro de Asiento de Ingreso</h3>
  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Registro de Asientos de Ingreso</h3>
      ...
      <form action="<?= base_url()?>cat_registro" method="post">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="hidden" class="form-control" value="1" name="id_nivel">
