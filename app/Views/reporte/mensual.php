...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1>Reporte por Mes de Ingresos y Egresos</h1>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
        ...
        <form>
          <div class="row">
            ...
            <div class="col-sm-3">
              <!-- text input -->
              <div class="form-group">
                <label>Seleccion de Mes:</label>
                <select class="form-control select2" style="width: 100%;">
                  <option selected disabled value="">Seleccionar Mes</option>
                  <option>Enero</option>
            ...
            <div class="col-sm-3">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <button type="submit" class="btn btn-primary">Visualizar Reporte</button>
              </div>
              </div>
            </div>
          </div>
