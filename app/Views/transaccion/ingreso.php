...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1>Formulario Registro de Movimiento de Ingreso</h1>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form id="myForm" action="<?= base_url()?>tran-reg-ingreso" method="post">
          <input type="hidden" value="1" name="id_nivel">
          <div class="row">
            <div class="col-sm-3">
              <!-- text input -->
          ...
          <div class="row" style="text-align: center;">
            <div class="col-sm-12">
              <div class="form-group">
                <button type="submit" class="btn btn-primary" id="submitButton">Registrar Ingreso</button>
              </div>
            </div>
          </div>
